...
$res_Usuarios = mysqli_query( $conexion, $Usuarios ) or die ( "Error en la consulta del listado en la base de datos");
...
<html >
	<head>
		<meta charset="UTF-8">
			<title>Lista de Usuarios - Colegio Don Bosco </title>
